...
ggsave(filename = "fig/posterior_sensitity_omega_uniform.pdf", plot=p, width = 7, height=4.5,units="in")

ggsave(filename = "fig/posterior_sensitity_omega_uniform.png", plot=p, width = 7, height=4.5,units="in")
